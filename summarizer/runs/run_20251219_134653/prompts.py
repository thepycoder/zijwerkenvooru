...
Taak:
1. Identificeer de argumenten VOOR dit voorstel (inclusief technische argumenten uit adviezen zoals Raad van State)
2. Identificeer de argumenten TEGEN of bezorgdheden (inclusief technische bezorgdheden uit adviezen)
...
{{
    "arguments_for": [{{"party": "Partij naam/namen of 'Technisch advies'", "argument": "Argument tekst"}}],
    "arguments_against": [{{"party": "Partij naam/namen of 'Technisch advies'", "argument": "Argument tekst"}}],
