...
Gebruik deze 2 punten als titels in je samenvatting. Start je samenvatting met de eerste titel, geen extra tekst.
Gebruik voor punt 1 een tot twee alinea's tekst om gemakkelijk te lezen, voor punt 2 bulletpoints (een niveau, niet meerdere) om op de kern te focusen.
...
{{
    ...
    "summary_debate": "Vat de grote lijnen van de debatten samen in een alinea."
}}
